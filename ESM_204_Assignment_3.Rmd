...
demand_agg <- function(p){
  q <- demand(p, model_1_dem_low) + demand(p, model_1_dem_high)
  return(q)}
...
- bullet point format for answers
- will place the answer to this question here. I am working it out on paper and will translate when done (Annie)
