...
Answer: The MEC is `r mec51` cents per Kwh electricity
...
#### Comsumer Benefit: `r round(CS_agg_sq, 0)`
...
CS_l_sq <- CS(10, model_1_dem_low)  # comsumer benefit to low income

CS_h_sq <- CS(10, model_1_dem_high)
...
Graphs if we want o show any.  It doesn't ask for any.
```{r}
